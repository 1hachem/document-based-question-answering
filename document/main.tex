...
\begin{center}
		\includegraphics[scale=0.17]{figures/ENP.png}
\end{center}
\begin{center}
...
under the supervison of Mr. Hakim \textsc{FOURAR LAID} ENP, Algiers
}
\begin{center}
...
\centering
\begin{tabular}{lrlcc}
\textbf{Président} & M. None & \textsc{test} & Prof. & ENP,  Alger \\
\textbf{Promotrice} & Mme. None & \textsc{test} & Dr. & ENP,  Alger \\
\textbf{Examinateur} & M. None & \textsc{test} & Prof. & ENP,  Alger
\end{tabular}
